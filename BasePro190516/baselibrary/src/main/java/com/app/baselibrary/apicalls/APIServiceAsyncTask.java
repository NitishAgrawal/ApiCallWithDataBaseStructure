...
public class APIServiceAsyncTask extends AsyncTask<Void, Integer, Object> {
    ...
    protected void onPreExecute() {
        ...
        if(CheckNetwork.isNetworkAvailable(mContext)) {
            ...
            if(BaseStru.isShowNetworkDialog())
    ...
    protected void onPostExecute(Object o) {
        ...
        if(o instanceof JSONObject){
            ...
            try {
                ...
                if(jsonObj.getString(BaseStru.getSuccessKey()).equals(BaseStru.getSuccessValue())){
    ...
    protected void success(JSONObject jsonObj,String serviceTaskType) {
    ...
    protected void failure(JSONObject jsonObj,String serviceTaskType) {

    }

    protected void onFinished(String serviceTaskType) {
